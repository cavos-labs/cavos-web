            ...
            <main className="container mx-auto px-4 py-12 md:py-44">
                ...
                >
                    <div className="relative w-full max-w-lg mx-auto h-64 bg-gradient-to-br from-[#11110E] to-[#1E1D19] rounded-2xl overflow-hidden border border-[#FFFFE3]/20 shadow-lg">
                        ...
                        <div className="absolute top-1/2 left-6 transform -translate-y-1/2 space-y-2">
                            <p className="text-[#FFFFE3]/80 text-sm font-medium tracking-wider">YOUR BALANCE</p>
                            <p className="text-3xl font-mono font-bold text-[#FFFFE3]">$23.12</p>
                            <div className="flex items-center gap-2 mt-4">
                                <span className="w-3 h-3 rounded-full bg-green-400 animate-pulse"></span>
                                <span className="text-xs text-[#FFFFE3]/70">Active</span>
                            </div>
                        </div>
                        <div className="absolute bottom-6 left-6">
                            <p className="text-xs text-[#FFFFE3]/60">•••• •••• •••• 4242</p>
                        </div>
                    </div>
                </motion.section>
                ...
                >
                    <div className="flex justify-between items-center mb-6 pb-2 border-b border-[#FFFFE3]/20">
                        <h2 className="text-xl font-bold text-[#FFFFE3]">TRANSACTIONS</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className="bg-[#FFFFE3]/10 p-3 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FFFFE3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        <line x1="12" y1="19" x2="12" y2="5"></line>
                                        <polyline points="5 12 12 5 19 12"></polyline>
                                    </svg>
                                </div>
                                <div>
                                    <p className="font-medium text-[#FFFFE3]">Invest</p>
                                    <p className="text-sm text-[#FFFFE3]/60">0x3b...d4d3</p>
                                </div>
                            </div>
                            <div className="text-right">
                                <p className="text-red-400 font-medium">-1.00 USD</p>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-medium text-[#FFFFE3]">Send</p>
                        ...
                        >
                            ...
                            <div className="text-right">
                                <p className="text-red-400 font-medium">-0.80 USD</p>
